// Generated on 2018-06-20 using generator-angular-fullstack 5.0.0-beta.3
'use strict';
...
gulp.task('copy:jsbootstrap:dev', () => {
    return gulp.src('node_modules/bootstrap/dist/js/bootstrap.min.js')
        .pipe(flatten())
        .pipe(gulp.dest(`${clientPath}/assets/js/bootstrap`));
});
gulp.task('copy:jsbootstrap:dist', () => {
    return gulp.src('node_modules/bootstrap/dist/js/bootstrap.min.js')
        .pipe(flatten())
        .pipe(gulp.dest(`${paths.dist}/${clientPath}/assets/js/bootstrap`));
});

/**
 * copy css file (JQUERY)
 */

gulp.task('copy:jsquery:dev', () => {
    return gulp.src('node_modules/jquery/dist/jquery.slim.min.js')
        .pipe(flatten())
        .pipe(gulp.dest(`${clientPath}/assets/js/jquery`));
});
gulp.task('copy:jsquery:dist', () => {
    return gulp.src('node_modules/jquery/dist/jquery.slim.min.js')
        .pipe(flatten())
        .pipe(gulp.dest(`${paths.dist}/${clientPath}/assets/js/jquery`));
});

/**
 * copy css file (PROPPER.JS)
 */

gulp.task('copy:jspopper:dev', () => {
    return gulp.src('node_modules/popper.js/dist/umd/popper.min.js')
        .pipe(flatten())
        .pipe(gulp.dest(`${clientPath}/assets/js/popper.js`));
});
gulp.task('copy:jspopper:dist', () => {
    return gulp.src('node_modules/popper.js/dist/umd/popper.min.js')
        .pipe(flatten())
